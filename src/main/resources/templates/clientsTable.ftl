...
<#--        <button class="dropdown-item btn btn-danger" onclick="window.location.href = '/web/client/list/sort/id'">Id</button>-->
        <button type="button" class="btn btn-outline-primary" onclick="window.location.href = '/web/client/list/sort/id'">
...
<#--        <button class="dropdown-item btn btn-danger" onclick="window.location.href = '/web/client/list/sort/name'">Name</button>-->
        <button type="button" class="btn btn-outline-primary" onclick="window.location.href = '/web/client/list/sort/name'">
...
<#--        <button class="dropdown-item btn btn-danger" onclick="window.location.href = '/web/client/list/sort/phone'">Phone</button>-->
        <button type="button" class="btn btn-outline-primary" onclick="window.location.href = '/web/client/list/sort/phone'">
        ...
        <button type="button" class="btn btn-outline-primary" onclick="window.location.href = '/web/client/list/sort/birthday'">
...
<#--                <td><a href="/web/client/delete/${element.id}" class="btn btn-outline-danger">Delete</a></td>-->
                <td><button type="button" class="btn btn-outline-danger" onclick="window.location.href='/web/client/delete/${element.id}'">
...
<#--                    <a href="/web/client/update/${element.id}" class="btn btn-outline-success">Edit</a>-->
                    <button type="button" class="btn btn-outline-success" onclick="window.location.href='/web/client/update/${element.id}'">
